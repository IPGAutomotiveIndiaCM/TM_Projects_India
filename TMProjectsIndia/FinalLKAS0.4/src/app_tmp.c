...
static char const *CompileLibs[] = {
    ...
    "libcar.a	CarMaker-Car win64 14.0 2024-11-26", "libcarmaker.a	CarMaker win64 14.0 2024-11-26",
    "libipgdriver.a	IPGDriver win64 14.0 2024-11-21", "libipgroad.a	IPGRoad win64 14.0 2024-11-22",
    "libipgtire.a	IPGTire win64 9.1.1 2024-10-08", NULL};

static char const *CompileFlags[] = {"-m64 -O3 -DNDEBUG -DWIN32 -DWIN64 -DCM_NUMVER=140000",
...
tAppStartInfo AppStartInfo = {
    "CarMaker 14.0 - Car_Generic", /* App_Version         */
    "4", /* App_BuildVersion    */
    "jetbrains", /* App_CompileUser     */
    "b5882e3d7d42", /* App_CompileSystem   */
    "2024-11-26 13:09:41", /* App_CompileTime */
