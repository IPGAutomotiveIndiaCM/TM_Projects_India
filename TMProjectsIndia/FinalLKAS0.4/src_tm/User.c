...
User_Calc(double dt)
{
    ...
    //Dev_Dist = DrivMan.LaneOffset;
    

    
   //if(Dev_Dist>0.5 )   //Positive Right Side
    
       // DrivMan.LaneOffset=0;
       
       //check if the driv.laneoffset is equal to 0 else 
    //  if (DrivMan.LaneOffset!=0)
      // DrivMan.LaneOffset   = -0.5;

   // else if(Dev_Dist<-0.5)
    //    DrivMan.LaneOffset=0;
    ...
    // if(Dev_Dist<-0.5)  //Left side Negative.
    // {
       
    //         VehicleControl.Steering.Ang = 5;      
    // }
