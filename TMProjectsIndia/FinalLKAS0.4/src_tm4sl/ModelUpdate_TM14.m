% Updates TM4SL Simulink models of Type TM11 to Type TM12
clear all;
close all;
...
ValidProd       = {'TruckMaker'}; % script only for TM4SL update
...
ReferenceModel  = 'generic_truck_src'; % Do not modify!
...
for iFile=1:numel(FileList)
    ...
    try
	    ...
	    %%%%% Add update scripts for the models HERE %%%%%
            ...
            update_CarAndTrailer_Kinematics_TM
            update_SuspensionForces_ReplaceSFuncs
            update_SuspensionExtForces_ReplaceOutputs_TM(src_mdl, trg_mdl)
            update_SuspensionForces_SuspExtFrcsUpdate
            update_CarAndTrailer_Kinetics_TM
            update_CarAndTrailer_Forces_CleanUp_TM(src_mdl, trg_mdl)
