...
include C:/IPG/carmaker/win64-13.0.1/include/MakeDefs.win64

# Matlab version in use.
MATSUPP_MATVER  = R2022b
MATSUPP_NUMVER  = 91300
...
MATLAB_ROOT	= $(subst \,/,C:\Program Files\MATLAB\R2022b)
ALT_MATLAB_ROOT	= $(subst \,/,C:\PROGRA~1\MATLAB\R2022b)
MAKECMD         = "C:/IPG/carmaker/win64-13.0.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= SwitchMobility_ACC
WRAPPER		= SwitchMobility_ACC_wrap
CLASS		= VehicleControl
DESCRIPTION	= "SwitchMobility_ACC"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
MODELREF_LINK_RSPFILE     = SwitchMobility_ACC_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = $(subst \,/,..)
MODELREF_TARGET_TYPE      = NONE

ADDITIONAL_LDFLAGS   = 

SRCS		= SwitchMobility_ACC_data.c rt_zcfcn.c
...
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\TruckMaker_MILEx\src_tm")
INC_CFLAGS	+= -I$(subst \,/,"C:\CM_Projects\TruckMaker_MILEx\src_tm\SwitchMobility_ACC_CarMaker_rtw")
...
ifeq ($(filter linux64 win32 win64 xeno lvrt nilrt ds1006 dsrt dsrtlx dsrt64, $(ARCH)), )
	$Q rm -f $@
	$(QECHO) " AR qs    $@"
	$Q $(AR) qs $@ $(OBJS)
else
